package ir.MrMohamadHosein.mvpfood.mainScreen
...
import ir.MrMohamadHosein.mvpfood.databinding.ActivityMainBinding
import ir.MrMohamadHosein.mvpfood.databinding.DialogAddNewItemBinding
import ir.MrMohamadHosein.mvpfood.databinding.DialogDeleteItemBinding
import ir.MrMohamadHosein.mvpfood.databinding.DialogUpdateItemBinding
import ir.MrMohamadHosein.mvpfood.model.Food
import ir.MrMohamadHosein.mvpfood.model.MyDatabase
import ir.MrMohamadHosein.mvpfood.utils.BASE_URL_IMAGE
import ir.MrMohamadHosein.mvpfood.utils.showToast
...
class MainScreenActivity : AppCompatActivity(), FoodAdapter.FoodEvents, MainScreenContract.View {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val sharedPreferences = getSharedPreferences("mvpFood", Context.MODE_PRIVATE)
